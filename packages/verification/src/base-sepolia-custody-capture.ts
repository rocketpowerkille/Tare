...
export const BaseSepoliaCustodyDeploymentSchema = z.strictObject({
...
export const BaseSepoliaCustodyCaptureSchema = z.strictObject({
  captureVersion: z.literal(1),
  scope: z.literal('base-sepolia-two-layer-erc4626-custody'),
...
export type BaseSepoliaCustodyCapture = z.infer<typeof BaseSepoliaCustodyCaptureSchema>;
export type BaseSepoliaCustodyDeployment = z.infer<typeof BaseSepoliaCustodyDeploymentSchema>;
