...
export function OperationForm({ capabilities, busy, operation, onOperationChange, onQueryChange, onDiscover, onRun }: {
  ...
  return <section className="query-panel">
    ...
    <form onSubmit={submit}>
      <p className="form-intro">Start with your public wallet address. Tare searches indexed Morpho V1 and V2 positions across supported networks, plus configured ERC-4626 registries.</p>
      ...
      <details className="advanced-options">
        ...
        <div className="advanced-options-body">
          ...
          {['resolve-v1', 'resolve-erc4626'].includes(operation) && <><label htmlFor="chain">Network</label><select id="chain" value={chainId} onChange={event => { setChainId(Number(event.target.value)); onQueryChange(); }}>
