...
export function DevelopersPage() {
  return <div className="developer-page page-width">
    ...
    <section className="developer-section">
      ...
      <p>Explorer and wallet investigations reuse this pricing path. Morpho V2 discovery outside the supported Ethereum USDC nested path selects resolve-erc4626 with an Accounting only label; it does not enable strategy tracing. Local tare_analyze exposes pricing through the shared schema; the compact gateway does not advertise a standalone valuation tool. The amount remains caller-supplied accounting, not custody or backing evidence. Euler downstream tracing and additional Graph accounting coverage require separate adapters and acceptance.</p>
    </section>
