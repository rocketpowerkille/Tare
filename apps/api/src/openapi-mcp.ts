            ...
            'application/json': {
              schema: {
                ...
                properties: {
                  operation: {
                    type: 'string',
                    enum: ['resolve-v1', 'resolve-v2', 'resolve-erc4626', 'verify-shares', 'verify-accounting', 'verify-graph-composition', 'verify-historical-graph', 'verify-weth', 'verify-base-custody'],
                  },
                  owner: address,
                  vault: address,
